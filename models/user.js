...
class User {
   ...
   *
   * Returns { username, first_name, last_name, is_admin, applied }
   *   where applied is [ jobId, jobId, ... ]
   *
  ...
  static async get(username) {
    ...
    user.applied = applicationsRes.rows.map(r => r.job_id);
  ...
  /** Given a username and job id add in applications DB. */
  ...
  static async applyToJob(username, jobId, state) {
    ...
    await db.query(
      ...
      VALUES ($1, $2, $3)`, [username, jobId, state]);
