...
//  }
  ...
  /** Find all companies with filters (by company name, minEmployees, maxEmployees, )
 *
 * Returns [{ handle, name, description, numEmployees, logoUrl }, ...]
 * */
  //name ILIKE ('%' || $1 || '%'), minEmployees >= num_employees, num_employees <= maxEmployees
  static async findAll(data) {

    const { whereClause, values } = sqlForSearch(data);
